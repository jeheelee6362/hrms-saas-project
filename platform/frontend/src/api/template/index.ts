...
class HttpService {
  ...
  private baseURL = process.env.WAS_BASE_URL;
  ...
  public async get<T>(
    url: string,
    params?: APIModel.IParams,
    hasAttachment = false
  ): Promise<T> {
    return this.request<T>(APIModel.EHttpMethod.GET, url, {
      params,
  ...
  public async push<T, P>(
    ...
    return this.request<T>(APIModel.EHttpMethod.POST, url, {
      params,
      data: payload,
      headers: this.setupHeaders(hasAttachment),
    });
  ...
  public async update<T, P>(
    ...
    return this.request<T>(APIModel.EHttpMethod.PUT, url, {
      params,
      data: payload,
      headers: this.setupHeaders(hasAttachment),
    });
  ...
  public async remove<T>(
    ...
    return this.request<T>(APIModel.EHttpMethod.DELETE, url, {
      params,
      headers: this.setupHeaders(hasAttachment),
    });
  }
